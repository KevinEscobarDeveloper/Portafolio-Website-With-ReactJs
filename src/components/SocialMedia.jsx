  ...
  return (
    <div className='social-media'>
        ...
        <ul >
          ...
          <div className="figure"><li> <a href='https://www.tiktok.com/@techcodee?lang=es' target="_blank" rel='noopener noreferrer'>Tiktok</a> <img  src={require("../icons/social-media/tiktok.png")} alt=''/></li></div>
